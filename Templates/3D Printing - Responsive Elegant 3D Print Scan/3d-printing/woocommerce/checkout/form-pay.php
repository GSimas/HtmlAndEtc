...
<form id="order_review" method="post">
	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php _e( 'Qty', '3dprinting' ); ?></th>
				<th class="product-total"><?php _e( 'Totals', '3dprinting' ); ?></th>
			</tr>
		</thead>
		<tbody>
	...
	<div id="payment">
		<h2><?php echo esc_html__('Payment','3dprinting')?></h2>
			...
			<ul class="wc_payment_methods payment_methods methods">
				<?php
					if ( ! empty( $available_gateways ) ) {
						...
						echo '<li>' . apply_filters( 'woocommerce_no_available_payment_methods_message', __( 'Sorry, it seems that there are no available payment methods for your location. Please contact us if you require assistance or wish to make alternate arrangements.', '3dprinting' ) ) . '</li>';
					}
				?>
			</ul>
		<?php endif; ?>
