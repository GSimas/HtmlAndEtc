...
<!-- Header Navigation -->
<div id="zo-header" class="zo-main-header header-style02 header-default <?php echo $transparent; ?> <?php if (!$smof_data['menu_sticky']) {
	echo 'no-sticky';
    ...
    <div class="<?php echo $container;?>">
		  <div class="row zo-header-main">
			...
			<div class="zo-header-secondary hidden-xs">
                <?php
			...
			<div class="zo-header-style02-menu">
				<div class="zo-header-menu">
