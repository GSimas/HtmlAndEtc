        ...
        <section id="sec1">
            <div class="container">
				...
				<?php endwhile; wp_reset_postdata(); ?>							
					...
					<div style="display:none;"><?php the_tags(); next_posts_link(); previous_posts_link();the_post_thumbnail();wp_link_pages();comment_form();paginate_comments_links();previous_comments_link(); wp_enqueue_script('comment-reply');?></div>				
