        ...
        <section id="sec1">
            <div class="container">
                ...
                <div class="section-title">				    
					<?php if(!empty($wr_options['arch-page-title'])): ?>
                    <div class="sect-subtitle" data-top-bottom="transform: translateY(-300px);" data-bottom-top="transform: translateY(300px);"><span><?php echo esc_attr(($wr_options['arch-page-title']));?></span></div>
                    <h3><?php single_month_title(' '); ?>  </h3>  
                    <h2><?php echo esc_attr(($wr_options['arch-page-title']));?></h2>	
					<?php else:?>
                    <div class="sect-subtitle" data-top-bottom="transform: translateY(-300px);" data-bottom-top="transform: translateY(300px);"><span><?php esc_attr_e('Archive', 'bionick');?></span></div>
                    <h3><?php single_month_title(' '); ?>  </h3>  
                    <h2><?php esc_attr_e('Archive', 'bionick');?></h2>						
					<?php endif; ?>	
