        ...
        <section id="sec1">
            <div class="container">
                ...
                <div class="section-title">
				    <?php if(!empty($wr_options['tag-page-title'])): ?>
                    <div class="sect-subtitle" data-top-bottom="transform: translateY(-300px);" data-bottom-top="transform: translateY(300px);"><span><?php echo esc_attr(($wr_options['tag-page-title']));?></span></div>
                    <h3><?php single_tag_title(); ?> </h3>  
                    <h2><?php echo esc_attr(($wr_options['tag-page-title']));?></h2>	
                    <?php else:?>					
                    <div class="sect-subtitle" data-top-bottom="transform: translateY(-300px);" data-bottom-top="transform: translateY(300px);"><span><?php esc_attr_e('Tag', 'bionick');?></span></div>
                    <h3><?php single_tag_title(); ?> </h3>  
                    <h2><?php esc_attr_e('Tag', 'bionick');?></h2>
                    <?php endif; ?>						
