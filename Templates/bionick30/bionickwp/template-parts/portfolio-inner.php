			...
			<?php };?>
                ...
                <div class="grid-item-holder">
					...
					<div class="grid-item">
						...
						<span class="prf-in-cat"><?php $portfolio_category = wp_get_post_terms($post->ID, 'portfolio_category'); $separator = ', '; $output = ''; if($portfolio_category){foreach($portfolio_category as $category) {$output .= $category->name.$separator;} echo trim($output, $separator); } ?></span>
		...
		<div class="gallery-items grid-small-pad" >
			...
			<?php };?>
                ...
                <div class="grid-item-holder">
					...
					<div class="grid-item">
					    <h3><a href="<?php the_permalink();?>"><?php the_title();?></a></h3>
						<span class="prf-in-cat"><?php $portfolio2_category = wp_get_post_terms($post->ID, 'portfolio2_category'); $separator = ', '; $output = ''; if($portfolio2_category){foreach($portfolio2_category as $category) {$output .= $category->name.$separator;} echo trim($output, $separator); } ?></span>
						<?php if (( get_post_meta($post->ID,'rnr_port_icon',true))):?>
						<i class="fa <?php echo (get_post_meta($post->ID,'rnr_port_icon',true)) ?>"></i>
						<?php else:?>
						<i class="fa fa-camera-retro"></i>
		...
		<div class="gallery-items grid-small-pad" >
			...
			<?php };?>
                ...
                <div class="grid-item-holder">
					...
					<div class="grid-item">
					    <h3><a href="<?php the_permalink();?>"><?php the_title();?></a></h3>
						<span class="prf-in-cat"><?php $portfolio3_category = wp_get_post_terms($post->ID, 'portfolio3_category'); $separator = ', '; $output = ''; if($portfolio3_category){foreach($portfolio3_category as $category) {$output .= $category->name.$separator;} echo trim($output, $separator); } ?></span>
						<?php if (( get_post_meta($post->ID,'rnr_port_icon',true))):?>
						<i class="fa <?php echo (get_post_meta($post->ID,'rnr_port_icon',true)) ?>"></i>
						<?php else:?>
						<i class="fa fa-camera-retro"></i>
