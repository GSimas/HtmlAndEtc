                        ...
                        <div class="content">
                            ...
                            <section id="sec1">
                                ...
                                <?php if(have_posts()): while ( have_posts() ) : the_post();?>
                                    ...
                                    <h3><?php $portfolio3_category = wp_get_post_terms($post->ID, 'portfolio3_category'); $separator = ', '; $output = ''; if($portfolio3_category){foreach($portfolio3_category as $category) {$output .= $category->name.$separator;} echo trim($output, $separator); } ?> </h3>
                                    <h2><?php the_title();?></h2>
                                    ...
                                    <div class="project-decr">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <h4> <?php $portfolio3_category = wp_get_post_terms($post->ID, 'portfolio3_category'); $separator = ', '; $output = ''; if($portfolio3_category){foreach($portfolio3_category as $category) {$output .= $category->name.$separator;} echo trim($output, $separator); } ?></h4>
                                                </li>
