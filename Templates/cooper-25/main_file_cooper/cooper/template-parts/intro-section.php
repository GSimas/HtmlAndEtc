...
<?php elseif (( get_post_meta($post->ID,'rnr_sec-intro-style',true))=='image2'):?>

<?php get_template_part('template-parts/intro-section-image2');?>
...
<?php elseif (( get_post_meta($post->ID,'rnr_sec-intro-style',true))=='carousel'):?>

<?php get_template_part('template-parts/intro-section-carousel');?>
