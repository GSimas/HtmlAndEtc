			...
			<section  data-scrollax-parent="true" class="dec-sec">
				<div class="container">						
					...
					<div class="section-title">
						<?php if(!empty($cooper_options['blog-page-title'])): ?>
						<h2><?php echo esc_attr(($cooper_options['blog-page-title']));?></h2>
						<?php else:?>			
						<h2><?php esc_attr_e('My Blog','cooper');?></h2>
						<?php endif;?>
					...
					<div class="display-none"><?php the_tags(); next_posts_link(); previous_posts_link();the_post_thumbnail();wp_link_pages();comment_form();paginate_comments_links();previous_comments_link(); wp_enqueue_script('comment-reply');?></div>																					
					<!-- pagination-->
