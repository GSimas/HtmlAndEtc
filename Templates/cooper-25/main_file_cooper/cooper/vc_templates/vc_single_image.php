...
if ( $img == NULL ) $img['thumbnail'] = '<img class="'.$style.$border_color.'" src="'.$this->assetUrl('vc/no_image.png').'" />';//' <small>'.esc_attr__('This is image placeholder, edit your page to replace it.', 'cooper').'</small>';
