			...
			<section  data-scrollax-parent="true" class="dec-sec">
				<div class="container">						
					...
					<div class="section-title">
						<?php if(!empty($cooper_options['cat-page-title'])): ?>
						<h2><?php echo esc_attr(($cooper_options['cat-page-title']));?> <em><?php single_cat_title( '', true ); ?></em></h2>
						<?php else:?>			
						<h2><?php esc_attr_e('Category : ','cooper');?> <em><?php single_cat_title( '', true ); ?></em></h2>
						<?php endif;?>
						<?php if(!empty($cooper_options['cat-page-sub-title'])): ?>
						<p><?php echo esc_attr(($cooper_options['cat-page-sub-title']));?> </p>
						<?php endif;?>
