			...
			<section  data-scrollax-parent="true" class="dec-sec">
				<div class="container">	
					...
					<div class="section-title">					
						<?php if(!empty($cooper_options['src-page-title'])): ?>
							<h2><?php echo esc_attr(($cooper_options['src-page-title']));?> <em><<?php printf( esc_attr__( ' "%s"', 'cooper' ), '<strong>' . get_search_query() . '</strong>' ); ?></em></h2>
						<?php else:?>	
							<h2><?php esc_attr_e('Search Results for : ','cooper');?> <em><?php printf( esc_attr__( ' "%s"', 'cooper' ), '<strong>' . get_search_query() . '</strong>' ); ?></em></h2>
						<?php endif;?>	
					...
					<div class="wrapper-content nothing-found">
						...
						<h3><?php esc_attr_e('Nothing Found', 'cooper'); ?></h3>
						</div>
						<br>
						<div class="sec-text ">
						<p><?php esc_attr_e('Sorry, but nothing matched your search criteria. Please try again with some different keywords.', 'cooper'); ?></p>
						</div>					
